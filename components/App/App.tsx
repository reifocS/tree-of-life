...
function drawLeaf(rc: RoughCanvas, ctx: CanvasRenderingContext2D, x: number, y: number, width: number, height: number, image: HTMLImageElement, isSelected: boolean) {
...
function drawIt(
  ...
  for (const element of elements) {
    if (element.type === "category") {
      ...
      drawLeaf(rc, ctx, element.x, element.y, element.width!, element.height!, image, element.id === selectedId)
    }
  }
...
function draw(
  ...
  drawIt(roughCanvas, canvas, elements, image, sectors, selectedId);
